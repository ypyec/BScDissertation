...
public class BoxHealth : MonoBehaviour {
	...
	public int healthPackChance = 35;
	public int powerPackChance = 15;
	public float respawnRate = 60f;
	public GameObject healthPackObj;
	public GameObject powerPackObj;
	...
	void DropHealthPack(){
		...
		} else if(powerPackChance+healthPackChance >= rng){ 
			GameObject powerPack = (GameObject)Instantiate (powerPackObj, transform.position, powerPackObj.transform.rotation);
		} else if (rng == 99) {
